...
public class TestCGenerator {
    ...
    public static void main(String[] args) {
        ...
        table.insertMnemonic("ldv.u3", new Token("ldv.u3", "newLine", new Position(5,1)));
        table.insertMnemonic(".cstring", new Token(".cstring", "newLine", new Position(6,1)));
        ...
        ILineStatement line4 = new LineStatement(null, new Instruction("ldc.i3", "-1", new Position(1,1)), new Comment("; OK, number <i3> [-4..3].", new Position(2,1)));
        ILineStatement line5 = new LineStatement(null, new Instruction("ldv.u3", "2", new Position(1,1)), new Comment("; OK, number <u3> [0..7].", new Position(2,1)));
        ILineStatement line6 = new LineStatement(null, new Instruction(".cstring", "\"AB\"", new Position(1,1)), new Comment("; AB has 3 bytes", new Position(2,1)));
